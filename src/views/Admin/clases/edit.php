        ...
        <div class="bg-[#f5f6fa] w-[85%]">
            ...
            <div>
                <div class="w-[1150px] flex justify-between items-center text-center pl-4 pr-4 mb-7">
                    <p class="text-[30px]">Lista de Clases</p>
                    <p>Home/Clases</p>
                </div>
                <div class="w-[1150px] h-[50px] flex justify-between items-center border-2 border-[#a9b0b9] p-2 text-[12px] bg-white ml-6">
                    ...
                    <button id="open-modal" class="bg-blue-500 text-white px-4 py-2 rounded-lg mr-8">Agregar clase</button>
                </div>
            </div>
                    ...
                    <div class="modal-container bg-white w-[400px] h-[400px] md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                        ...
                        <div class="modal-content py-4 text-left ">
                            <div class="flex justify-between items-center pb-3 mb-3  border-b border-[#a9b0b9]">
                                <p class="text-2xl font-bold mx-4">Agregar Clase</p>
                            </div>
                            <form class="flex flex-col gap-2" action="/clase" method="post">
                                <div class="flex flex-col justify-center items-start pl-4 mb-2">
                                    <label for="">Maestros disponibles para la clase</label>
                                    <select type="text" id="input-group-1" class=" mb-6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 flex w-[370px] h-[42px] pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="maestro">
                                        <?php
                                        foreach ($maestros as $maestro) {
                                        ?>
                                            <option class="w-[370px] rounded-md flex mb-2" value="<?= $maestro["id"] ?>"><?= $maestro["nombres"] ?></option>
                                        <?php
                                        };
                                        ?>
                                </div>
                                <div class="flex flex-col justify-center items-start pl-4 mb-9 h-9">
                                    <label class="mt-6">Nombre de la Materia</label>
                                    <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[370px] h-[42px] pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingrese la clase" name="clase">
                                </div>
                            ...
                            <div class="absolute top-[330px] ml-6">
            ...
            <div class="ml-6">
                <table class=" bg-slate-400 table-fixed selection:border-collapse border border-slate-400 w-[1100px] text-[12px]">
                    ...
                    <th class="border border-slate-300 text-center">CLASE</th>
                    <th class="border border-slate-300 text-center">MAESTRO</th>
                    <th class="border border-slate-300 text-center">ALUMNOS INSCRITOS</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr class="odd:bg-white even:bg-slate-50 ">
                                <td class="border border-slate-300 text-center"><?= $clases["clase_id"] ?></td>
                                <td class="border border-slate-300 text-center"><?= $clases["nombre_clase"] ?></td>
                                <td class="border border-slate-300 text-center"><?= $clases["nombre_maestro"] ? $clases["nombre_maestro"] : "Sin Asignar" ?></td>
                                <td class="border border-slate-300 text-center"><?= $clases["total_alumnos"] ?></td>
                                <td class="border border-slate-300 text-center flex w-[90px] h-[70px] items-center">
                                    <a class="w-[20px] ml-3 mr-3" href="/claseedit?id=<?= $clases["clase_id"] ?>">
                                    ...
                                    <form action="/deleteclase" method="post">
                                        <button type="submit" name="clase_id" value="<?= $clases["clase_id"] ?>">
            ...
            <div class="bg-gray-100  flex items-center justify-center">
                ...
                <div id="modalmaestro2" class="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div class="modal-container bg-white w-[400px] h-[350px] md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                        <!-- Contenido del modal -->
                        <div class="modal-content py-4 text-left ">
                            <div class="flex justify-between items-center pb-3 mb-3  border-b border-[#a9b0b9]">
                                <p class="text-2xl font-bold mx-4">Editar Clase</p>
                            </div>
                            <form class="flex flex-col gap-2" action="/claseedit" method="post">
                                <div class="flex flex-col justify-center items-start pl-4 mb-2">
                                    <label for="">Maestros disponibles para la clase</label>
                                    <select type="text" id="input-group-1" class=" mb-6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 flex w-[370px] h-[42px] pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="maestro">
                                        <?php
                                ...
                                <div class="flex flex-col justify-center items-start pl-4 mb-9 h-9">
                                    <label class="mt-6">Nombre de la Materia</label>
                                    <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[370px] h-[42px] pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="<?=$claseid["nombre_clase"] ?>" name="clase">
                                    <input type="hidden" name="id" value="<?= $claseid["clase_id"] ?>">
                                </div>
                            ...
                            <div class="absolute top-[355px] ml-6">
                                <a href="/clases">
            ...
            <script>
                const openModalButton2 = document.getElementById("open-modalmaestro2");
                const modal2 = document.getElementById("modalmaestro2");
                const closeModalButton2 = document.getElementById("close-modalmaestro2");
