        ...
        <div class="bg-[#f5f6fa]">
            ...
            <div>
                <div class="w-[1150px] flex justify-between items-center text-center pl-4 pr-4 mb-7">
                    <p class="text-[30px]">Lista de Permisos</p>
                    <p>Home/Permisos</p>
                </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr class="odd:bg-white even:bg-slate-50 ">
                                <td class="border border-slate-300 text-center"><?= $permiso["id"] ?></td>
                                <td class="border border-slate-300 text-center"><?= $permiso["email"] ?></td>
                                <?php
                                switch ($permiso["nombre"]) {
                                    case 'Admin':
                                ?>
                                        <td class="border border-slate-300 text-center">
                                            <p class="bg-[#febf06] w-[60px] ml-[130px] rounded flex justify-center items-center text-[16px] text-black"><?= $permiso["nombre"] ?></p>
                                        </td>
                                    <?php
                                        break;
                                    case 'Maestro':
                                    ?>
                                        <td class="border border-slate-300 text-center">
                                            <p class="bg-[#1ba0b5] w-[60px] ml-[130px] rounded flex justify-center items-center text-[16px] text-white"><?= $permiso["nombre"] ?></p>
                                        </td>
                                    <?php
                                        break;
                                    case 'Alumno':
                                    ?>
                                        <td class="border border-slate-300 text-center">
                                            <p class="bg-[#6b757e] w-[60px] rounded flex justify-center items-center text-[16px] text-white ml-[130px]"><?= $permiso["nombre"] ?></p>
                                        </td>
                                <?php
                                        break;
                                    default:
                                        echo "No se encontro Rol";
                                        break;
                                }
                                ?>
                                <?= $permiso["active"] === 1 ? '<td class="border border-slate-300 items-center"><p class="bg-blue-600 w-[60px] ml-[130px] rounded flex justify-center items-center text-[16px] text-white">Active</p></td>' : '<td class="border border-red-300 text-center flex justify-center items-center"><p class="bg-blue-600 w-11 flex justify-center items-center text-[20px]">Inactive</p></td>' ?>

                                <td class="border border-slate-300 text-center flex w-[90px] h-[70px] items-center">
                                    <a class="w-[20px] ml-[30px] mr-3" href="/permisoedit?id=<?= $permiso["id"] ?>">
