        ...
        <div class="bg-[#f5f6fa] w-[85%]">
            ...
            <div class="bg-gray-100  flex items-center justify-center">
                ...
                <div id="modalmaestro" class="fixed inset-0 z-50 flex items-center justify-center hidden">
                    ...
                    <div class="modal-container bg-white w-[400px] h-[700px] md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                        <!-- Contenido del modal -->
                        <div class="modal-content py-4 text-left ">
                            ...
                            <form class="flex flex-col gap-1" action="/maestro" method="post">
                                <div class="flex flex-col justify-center items-start pl-4 h-[20px]">
                                    ...
                                    <select type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[370px] h-[10px] pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="clase_id">
                                        <?php
                    ...
                    <div class="modal-container bg-white w-[400px] h-[600px] md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                        ...
                        <div class="modal-content py-4 text-left ">
                            ...
                            <form class="flex flex-col gap-4" action="/maestroedit" method="post">
                                ...
                                <div class="flex flex-col justify-center items-start pl-4">
                                    <label for="">Apellido(s)</label>
                                    <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[370px] h-[32px] pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="<?= $datauser["apellidos"] ?>" name="apellidos">
                                </div>
                                <div class="flex flex-col justify-center items-start pl-4">
                                    <label for="">Dirección</label>
                                    <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[370px] h-[32px] pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="<?= $datauser["direccion"] ?>" name="direccion">
                                </div>
                                <div class="flex flex-col justify-center items-start pl-4">
                                    <label for="">Fecha de nacimiento</label>
