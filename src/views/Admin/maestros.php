                        ...
                        <div class="modal-content py-4 text-left ">
                            ...
                            <form class="flex flex-col gap-2" action="/maestro" method="post">
                                <div class="flex flex-col justify-center items-start pl-4 mb-2">
                                    ...
                                    <select type="text" id="input-group-1" class=" mb-6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 flex w-[370px] h-[40px] pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="clase_id">
                                        <?php
