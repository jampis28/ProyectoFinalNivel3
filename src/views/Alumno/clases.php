        ...
        <div class="bg-[#f5f6fa] w-[85%]">
                        ...
                        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            ...
                            <div class="">
                                ...
                                <div id="hidden-menu" class="hidden bg-white absolute right-1 top-14 mt-2 w-35 rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
                                    <a href="/perfil" class="flex justify-start items-center px-4 py-2 text-sm text-gray-700">
            ...
            <div>
                <div class="w-[1150px] flex justify-between items-center text-center pl-4 pr-4 mb-7">
                    <p class="text-[30px]">Esquema de Clases </p>
                    <p>Home/Clases</p>
                </div>
                <div class="flex">
                    <div class="flex flex-col">
                        <div class="w-[600px] h-[40px] flex flex-col justify-center items-start border-2 border-[#a9b0b9] p-2 text-[12px] bg-white ml-6">
                        ...
                        <div class="flex gap-[230px] ml-6">
                            <div class="w-[40%] ">
                                <table class="table-fixed selection:border-collapse border border-slate-400 w-[600px] text-[12px] ">
                                    ...
                                    <th class="border border-slate-300 text-center w-[250px]">Darse de baja</th>
                                    <tbody>
                                        <?php
                                        ...
                                        ?>
                                            ...
                                            <tr class="odd:bg-white even:bg-slate-50 h-9">
                                                <td class="border border-slate-300 text-center"><?= $materia["id"] ?></td>
                                                <td class="border border-slate-300 text-center"><?= $materia["nombre"] ?></td>
                                                <td class="border border-slate-300 text-center">
                                                    <form action="/deletealumnoclases" method="post">
                    ...
                    <div class="w-[25%]">
                        <div class="w-[100%] h-[40px] flex flex-col justify-center items-start border-2 border-[#a9b0b9] p-2 text-[12px] bg-white ml-6">
                            <h1>Materias para Inscribir</h1>
                        </div>
                        <div class="w-[100%]  flex flex-col justify-center items-start border-l border-r border-b border-[#a9b0b9] p-2 text-[12px] bg-white ml-6">
                            <label for="countries_multiple" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Selecciona la(s) clase(s) use la tecla ctrl</label>
